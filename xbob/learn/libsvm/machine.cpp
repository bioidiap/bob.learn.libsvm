...
PyDoc_STRVAR(s_svm_str, XBOB_EXT_MODULE_PREFIX ".KernelMachine");

PyDoc_STRVAR(s_svm_doc,
"KernelMachine(filename)\n\
KernelMachine(hdf5file)\n\
\n\
...
static int PyBobLearnLinearMachine_init_svmfile
