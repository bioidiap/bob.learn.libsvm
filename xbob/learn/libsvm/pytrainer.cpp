...
static int PyBobLearnLibsvmTrainer_init_svmfile
(PyBobLearnLibsvmTrainerObject* self, PyObject* args, PyObject* kwds) {
  ...
  try {
    self->cxx = new bob::learn::libsvm::Trainer(c_filename);
  }
...
static int PyBobLearnLibsvmTrainer_init_hdf5
(PyBobLearnLibsvmTrainerObject* self, PyObject* args, PyObject* kwds) {
  ...
  try {
    self->cxx = new bob::learn::libsvm::Trainer(*(h5f->f));
  }
  catch (std::exception& ex) {
    PyErr_SetString(PyExc_RuntimeError, ex.what());
    return -1;
...
static int PyBobLearnLibsvmTrainer_init(PyBobLearnLibsvmTrainerObject* self,
  ...
  if (PyBobIoHDF5File_Check(arg)) {
    return PyBobLearnLibsvmTrainer_init_hdf5(self, args, kwds);
  }
  else {
    return PyBobLearnLibsvmTrainer_init_svmfile(self, args, kwds);
  }
...
static PyObject* PyBobLearnLibsvmTrainer_getInputSubtraction
...
static int PyBobLearnLibsvmTrainer_setInputSubtraction
...
static PyObject* PyBobLearnLibsvmTrainer_getInputDivision
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
  return PyBlitzArray_NUMPY_WRAP(PyBlitzArrayCxx_NewFromConstArray(self->cxx->getInputDivision()));
}

static int PyBobLearnLibsvmTrainer_setInputDivision
(PyBobLearnLibsvmTrainerObject* self, PyObject* o, void* /*closure*/) {
...
static PyObject* PyBobLearnLibsvmTrainer_getShape
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
...
static PyObject* PyBobLearnLibsvmTrainer_getLabels
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
...
static PyObject* PyBobLearnLibsvmTrainer_getSvmType
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
  switch(self->cxx->machineType()) {
    case bob::learn::libsvm::Trainer::C_SVC:
      return Py_BuildValue("s", "C_SVC");
    case bob::learn::libsvm::Trainer::NU_SVC:
      return Py_BuildValue("s", "NU_SVC");
    case bob::learn::libsvm::Trainer::ONE_CLASS:
      return Py_BuildValue("s", "ONE_CLASS");
    case bob::learn::libsvm::Trainer::EPSILON_SVR:
      return Py_BuildValue("s", "EPSILON_SVR");
    case bob::learn::libsvm::Trainer::NU_SVR:
...
static PyObject* PyBobLearnLibsvmTrainer_getSvmKernelType
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
  switch(self->cxx->kernelType()) {
    case bob::learn::libsvm::Trainer::LINEAR:
      return Py_BuildValue("s", "LINEAR");
    case bob::learn::libsvm::Trainer::POLY:
      return Py_BuildValue("s", "POLY");
    case bob::learn::libsvm::Trainer::RBF:
      return Py_BuildValue("s", "RBF");
    case bob::learn::libsvm::Trainer::SIGMOID:
      return Py_BuildValue("s", "SIGMOID");
    case bob::learn::libsvm::Trainer::PRECOMPUTED:
...
static PyObject* PyBobLearnLibsvmTrainer_getPolynomialDegree
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
...
static PyObject* PyBobLearnLibsvmTrainer_getCoefficient0
(PyBobLearnLibsvmTrainerObject* self, void* /*closure*/) {
...
static PyGetSetDef PyBobLearnLibsvmTrainer_getseters[] = {
    {
      ...
      (getter)PyBobLearnLibsvmTrainer_getInputSubtraction,
      (setter)PyBobLearnLibsvmTrainer_setInputSubtraction,
      s_input_subtract_doc,
      0
    },
    {
      s_input_divide_str,
      (getter)PyBobLearnLibsvmTrainer_getInputDivision,
      (setter)PyBobLearnLibsvmTrainer_setInputDivision,
      s_input_divide_doc,
      0
    },
    {
      s_shape_str,
      (getter)PyBobLearnLibsvmTrainer_getShape,
      0,
      s_shape_doc,
      0
    },
    {
      s_labels_str,
      (getter)PyBobLearnLibsvmTrainer_getLabels,
      0,
      s_labels_doc,
      0
    },
    {
      s_svm_type_str,
      (getter)PyBobLearnLibsvmTrainer_getSvmType,
      0,
      s_svm_type_doc,
      0
    },
    {
      ...
      (getter)PyBobLearnLibsvmTrainer_getSvmKernelType,
      0,
    ...
    {
      s_degree_str,
      (getter)PyBobLearnLibsvmTrainer_getPolynomialDegree,
      0,
      s_degree_doc,
      0
    },
    ...
    {
      s_coef0_str,
      (getter)PyBobLearnLibsvmTrainer_getCoefficient0,
      0,
      s_coef0_doc,
      0
    },
...
PyObject* PyBobLearnLibsvmTrainer_Repr(PyBobLearnLibsvmTrainerObject* self) {
   ...
   * Expected output:
   *
   * <xbob.learn.libsvm.Trainer float64@(3, 2)>
   */
...
PyObject* PyBobLearnLibsvmTrainer_Str(PyBobLearnLibsvmTrainerObject* self) {
   ...
   * Expected output:
   *
   * xbob.learn.libsvm.Trainer (float64) 3 inputs, 2 outputs
   *   properties...
   *
   * TODO: Not fully implemented yet
   */

  return PyBobLearnLibsvmTrainer_Repr(self);
...
\n\
Calculates the **predicted class** using this Trainer, given\n\
...
static PyObject* PyBobLearnLibsvmTrainer_forward
(PyBobLearnLibsvmTrainerObject* self, PyObject* args, PyObject* kwds) {
...
using the this Trainer, given one single feature vector or multiple\n\
ones.\n\
\n\
The ``input`` array can be either 1D or 2D 64-bit float arrays.\n\
...
static PyObject* PyBobLearnLibsvmTrainer_predictClassAndScores
(PyBobLearnLibsvmTrainerObject* self, PyObject* args, PyObject* kwds) {
...
SVM using the this Trainer, given one single feature vector or\n\
multiple ones.\n\
\n\
The ``input`` array can be either 1D or 2D 64-bit float arrays.\n\
The ``cls`` array, if provided, must be of type ``int64``,\n\
...
static PyObject* PyBobLearnLibsvmTrainer_predictClassAndProbabilities
(PyBobLearnLibsvmTrainerObject* self, PyObject* args, PyObject* kwds) {
...
static PyObject* PyBobLearnLibsvmTrainer_Save
(PyBobLearnLibsvmTrainerObject* self, PyObject* f) {
...
static PyMethodDef PyBobLearnLibsvmTrainer_methods[] = {
  {
    s_forward_str,
    (PyCFunction)PyBobLearnLibsvmTrainer_forward,
  ...
  {
    s_scores_str,
    (PyCFunction)PyBobLearnLibsvmTrainer_predictClassAndScores,
    METH_VARARGS|METH_KEYWORDS,
    s_scores_doc,
  },
  {
    s_probabilities_str,
    (PyCFunction)PyBobLearnLibsvmTrainer_predictClassAndProbabilities,
    METH_VARARGS|METH_KEYWORDS,
    s_probabilities_doc,
  },
  {
    s_save_str,
    (PyCFunction)PyBobLearnLibsvmTrainer_Save,
    METH_O,
    s_save_doc
  },
  {0} /* Sentinel */
...
PyTypeObject PyBobLearnLibsvmTrainer_Type = {
    ...
    0,                                                /* tp_as_mapping */
    0,                                                /* tp_hash */
    (ternaryfunc)PyBobLearnLibsvmTrainer_forward,     /* tp_call */
